...
export default function BannerPlaceholder({ variant = "horizontal" }: Props) {
  ...
  // horizontal (default)
  return (
    <div className="w-full aspect-[8/1] min-h-[70px] md:min-h-[90px] border border-dashed border-[#CBD5E1] rounded-xl bg-[#FAFBFC] flex items-center justify-center p-4">
      <div className="text-center flex items-center gap-2">
        <svg className="w-5 h-5 text-[#CBD5E1]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.41a2.25 2.25 0 013.182 0l2.909 2.91m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
        </svg>
        <span className="text-[11px] font-extrabold text-[#CBD5E1] uppercase tracking-wider">Reklam Alanı (Yatay Banner — Önerilen: 1200x150 px)</span>
      </div>
    </div>
  );
}
