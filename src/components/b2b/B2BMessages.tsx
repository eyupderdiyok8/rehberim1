...
export default function B2BMessages() {
  ...
  const deleteConversation = async () => {
    if (!selectedId || !window.confirm("Bu görüşme mesaj listenizden kaldırılsın mı? Karşı tarafın kaydı silinmez.")) return;
    setDeleteBusy(true);
    setError("");
