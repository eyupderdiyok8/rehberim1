...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    {
      name: "B2B Hareketler",
      href: "/panel/admin/b2b/hareketler",
      badge: 0,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "B2B Reklamlar",
      href: "/panel/admin/b2b/reklamlar",
      badge: 0,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5L6 9H3v6h3l5 4V5zm4.5 3.5a5 5 0 010 7M18 6a8 8 0 010 12" />
        </svg>
      ),
    },
    {
