...
Eski `b2b_trade_network.sql` dosyasını daha önce çalıştırdıysanız da 001–004 dosyalarını sırayla çalıştırabilirsiniz. Komutlar mevcut tablo ve alanları koruyarak eksik kalan parçaları tamamlar.
