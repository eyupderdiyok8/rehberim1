...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Yeni teklif talebi geldiğinde anında WhatsApp ve e-posta bildirimi. Müşteriye hızlı yanıt vererek rakiplerin önüne geçin.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-2xl p-8 text-center space-y-5 shadow-lg shadow-emerald-500/10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <a
            href="https://suaritmaservisyazilimi.com.tr"
            target="_blank"
